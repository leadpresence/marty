class AppConstants {
  ...
  /// api urls
  static const String baseUrl = 'https://api.trolley.ng';
  static const String imageBaseUrl = '$baseUrl/storage/images';
  static const String adminPageUrl = 'https://admin.trolley.ng/login';
  static const String webUrl = 'https://trolley.ng';
  static const String privacyPolicyUrl = 'https://sundaymart.net/privacy-policy';
