...
class AppColors {
  ...
  static const Color green = Color(0xFF3CC18C);
  static const Color darkGreen = Color(0xFF03533F);
  ...
  static Color mainAppbar({bool? isDarkMode}) =>
      (isDarkMode ?? LocalStorage.instance.getAppThemeMode())
          ? darkGreen
          : darkGreen;
  ...
  static Color iconAndTextColorAppbar({bool? isDarkMode}) =>
      (isDarkMode ?? LocalStorage.instance.getAppThemeMode()) ? white : white;
