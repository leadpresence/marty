...
abstract class $ProductStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, ProductData? productData});
}
...
class _$_ProductState extends _ProductState {
  const _$_ProductState({this.isLoading = false, this.productData}) : super._();
  ...
  @override
  String toString() {
    return 'ProductState(isLoading: $isLoading, productData: $productData)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, productData);
...
abstract class _ProductState extends ProductState {
  const factory _ProductState(
      {final bool isLoading, final ProductData? productData}) = _$_ProductState;
